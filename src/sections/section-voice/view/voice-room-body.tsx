...
import { CURRENT_USER, DEMO_MESSAGES, INITIAL_PARTICIPANTS, ROOM } from '../@mock_/messages-data';
...
export function VoiceRoomBody({ selectedRoom }: { selectedRoom: RoomResponse | null }) {

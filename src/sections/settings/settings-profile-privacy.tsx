            ...
            <Box sx={{ mt: 1 }}>
              ...
              <RadioGroup
                ...
                onChange={(e) => {
                  ...
                  onSubmit({ profileVisibility: e.target.value as typeof privacy.profileVisibility });
                }}
              >
                <FormControlLabel
                  value="public"
            ...
            <Box sx={{ mt: 1 }}>
              ...
              <RadioGroup
                ...
                onChange={(e) => {
                  ...
                  onSubmit({ allowMessagesFrom: e.target.value as typeof privacy.allowMessagesFrom });
                }
                }
              >
                <FormControlLabel

                    ...
                    <Grid sx={{ xs: 12, sm: 6 }} key={method.key}>
                      ...
                      >
                        ...
                        <Switch
                          ...
                          onChange={() => {
                            setValue(
                              method.key as keyof typeof values,
                              !values[method.key as keyof typeof values]
                            );
                  ...
                  {category.items.map((item) => (
                    ...
                    >
                      ...
                      <Switch
                        ...
                        onChange={() => {
                          setValue(
                            item.key as keyof typeof values,
